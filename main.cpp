...
private:
    ...
    void initWindow() {
        ...
        m_window = glfwCreateWindow(WIDTH, HEIGHT, "GAEALAND", nullptr, nullptr);
    ...
    void createInstance() {
        ...
        appInfo.pApplicationName = "Gaealand";
    ...
    void createSyncObjects() {
        ...
        for (size_t i{0}; i < MAX_FRAMES_IN_FLIGHT; ++i) {
            if (vkCreateSemaphore(m_device, &semaphoreInfo, nullptr, &m_imageAvailableSemaphores[i]) != VK_SUCCESS ||
                ...
                throw std::runtime_error("failed to create synchronization objects for aframe!");
            }
        }
    }
    ...
    static std::vector<char> readFile(const std::string &filename) {
        ...
        if (!file.is_open()) {
            throw std::runtime_error("failed to open fie!");
        }
